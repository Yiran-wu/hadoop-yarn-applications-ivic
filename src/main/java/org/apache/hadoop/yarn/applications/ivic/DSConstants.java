...
public class DSConstants {
   ...
   */
  public static final String IVICSCRIPTLOCATION = "IVICSCRIPTLOCATION";

  /**
   * Environment key name denoting the file timestamp for the shell script. 
   * Used to validate the local resource. 
   */
  public static final String IVICSCRIPTTIMESTAMP = "IVICSCRIPTTIMESTAMP";

  /**
   * Environment key name denoting the file content length for the shell script. 
   * Used to validate the local resource. 
   */
  public static final String IVICSCRIPTLEN = "IVICSCRIPTLEN";

  /**
   * Environment key name denoting the timeline domain ID.
   */
  public static final String IVICTIMELINEDOMAIN = "IVICTIMELINEDOMAIN";
}
